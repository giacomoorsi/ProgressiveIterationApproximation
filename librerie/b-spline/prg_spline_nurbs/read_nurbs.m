% READ_NURBS: create a nurbs structure from a file with a format similar to the one of the NURBS toolbox.
%
% nurbs = read_nurbs (filename)
%
% INPUT :
%
...
function geom = read_nurbs (filename)

fid = fopen (filename, 'r');
if (fid < 0)
  error ('read_nurbs: cannot open file %s', filename);
end
