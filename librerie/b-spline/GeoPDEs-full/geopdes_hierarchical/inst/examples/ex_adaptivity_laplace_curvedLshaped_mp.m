...
problem_data.geo_name = 'geo_curvedL_3patches.txt';
...
% Singular function
k = 2; % Constant that characterizes the singularity
...
% EXPORT VTK FILE
npts = [51 51];
output_file = 'laplace_adaptivity_curvedLshaped_mp';
